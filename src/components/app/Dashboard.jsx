  ...
  return (
    <div className="appStackPages">
      ...
      >
        ...
        <div className="flex flex-col w-1/4 max-[400px]:w-full">
          ...
          <div className="flex flex-col items-center justify-center">
            <img
              ...
              alt=""
            />
            <h1 className="text-xl font-medium 2xl:text-3xl xl:text-2xl">
              {state.user.username}
            </h1>
          </div>
          ...
          <div className="flex flex-col items-center justify-center pt-5">
            ...
            <h1 className="dashDisplayData">
              {globalCardNumber.selectedCardNumber}
            </h1>
        ...
        {/* dashboard block */}
        <div
          className="max-[400px]:w-full max-[400px]:max-w-[400px]   "
              ...
              <div className="">
                <div className="flex  justify-between items-end ">
                  ...
                  <p
                    ...
                    className="text-sm font-medium hover:text-EWred ease-linear duration-200 md:mr-20 cursor-pointer 2xl:text-xl"
                  >
                    View all Cards
                  </p>
                </div>
                <div
                  className={`flex justify-start items-center max-[400px]:items-start max-[400px]:overflow-x-auto`}
                  style={{ width: divSize.width < 500 ? "" : dashWidth }}
                >
                  <DisplayCard />
              ...
              <div>
                <div className="md:pr-5 md:w-500px ">
                  <div className="flex justify-between items-end ">
                    ...
                    <p className="text-sm font-medium hover:text-EWred ease-linear duration-200 cursor-pointer">
