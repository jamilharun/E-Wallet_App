    ...
    <div className=" w-fit h-fit md:w-500px">
      <div className="flex justify-end items-end rounded-b-lg absolute ">
        <p
          ...
          className={` px-2 ${filter === "all" ? "bg-EWpurple" : "bg-EWred"}`}
        >
          All
        </p>
        <p
          ...
          className={` px-2 ${
            filter === "Pending" ? "bg-EWpurple" : "bg-EWred"
          }`}
        >
          Pending
        </p>
        <p
          ...
          className={`px-2 ${
            filter === "success" ? "bg-EWpurple" : "bg-EWred"
          }`}
        >
          Success
        </p>
              ...
              return (
                ...
                >
                  ...
                  <img
                    ...
                    alt=""
                  />
                  <p className="truncate w-20 font-medium xl:font-normal xl:text-lg p-1">
