...
export default function Landing() {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      imageRef.current,
      { opacity: 0, y: -50 },
      { opacity: 1, y: 0, duration: 1, ease: "power2.out", delay: 0.33 }
    );
    gsap.fromTo(
      headingRef.current,
      { opacity: 0, y: 50 },
      { opacity: 1, y: 0, duration: 1, ease: "power2.out", delay: 0.66 }
    );
    gsap.fromTo(
  ...
  useEffect(() => {
    if (stateData.loggedIn) {
      ...
      gsap.fromTo(
        headingRef.current,
        { opacity: 1, y: 0 },
        { opacity: 0, y: 50, duration: 1, ease: "power2.out", delay: 0.33 }
      );
      gsap.fromTo(
        paragraphRef.current,
        { opacity: 1, y: 0 },
        { opacity: 0, y: 50, duration: 1, ease: "power2.out", delay: 0.66 }
      );
      gsap.fromTo(
        landingRef.current,
        { opacity: 1 },
        { opacity: 0, duration: 1, ease: "power2.out", delay: 1.5 }
      );
    }
  }, [stateData.loggedIn]);
  ...
  return (
    <div className="flex h-screen overflow-hidden ">
      ...
      >
        <img ref={imageRef} src={hero} alt="hero" className="w-1/2" />
        <h1
          ref={headingRef}
        ...
        >
          Welcome to E-Wallet Hero, Welcome to [Your E-Wallet Name], where
          managing your money is simple and secure.
        </p>
      </div>
      <Routes>
